...
export async function handleScan (status: ScanStatus, result: string, setStatus: Dispatch<SetStateAction<ScanStatus>>, setMessage: (message: string) => void, setGuestName: (name: string) => void ){
